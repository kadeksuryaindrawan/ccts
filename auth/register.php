...
<head>
    ...
    <title>Kartu Prakerja - Daftar</title>
</head>
<body class="font-poppins bg-blue-500">
        <div class="items-center flex flex-col md:flex-row bg-white md:mx-20 md:my-20 mx-5 my-10 px-5 md:px-10 py-10 md:py-20" style="box-shadow: 0px 3px 40px #333;">
            <div class="flex-1">
                <img src="../assets/images/register.svg" alt="" class="w-full hidden md:block">
            </div>
            <div class="flex-1 text-center">
                <h2 class="text-blue-500 font-pbold text-3xl leading-normal">USER <br> REGISTER</h2>
                ...
                <form action="./proses/register.proses.php" method="POST">
                    ...
                    <input name="input_repassword" type="password" class="bg-gray-200 mb-7 w-full px-7 py-4 focus:outline-none rounded-full" placeholder="Re - Password">
                    <input name="register" type="submit" class="w-full bg-blue-500 text-white tracking-wider px-7 py-4 focus:outline-none rounded-full cursor-pointer hover:bg-blue-700 duration-300 ease-in-out" value="DAFTAR">
                </form>
                </div>
                <div class="flex justify-between m-auto mt-5" style="max-width: 400px;">
                    ...
                    <p class="text-sm leading-7">Sudah punya akun? <a href="./login.php" class="text-blue-500">Masuk</a></p>
                </div>
            </div>
        </div>
</body>
