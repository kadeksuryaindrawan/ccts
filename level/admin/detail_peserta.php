<?php
    ...
    if(isset($_GET['id']) && !empty($_GET['id']) && is_numeric($_GET['id'])){
        $id= $_GET['id'];
        $query_check = mysqli_query($connection, "SELECT tb_datadiri.*,tb_users.* FROM tb_datadiri INNER JOIN tb_users USING(id_user) WHERE tb_datadiri.id_user = $id");
                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                            ...
                                                            <div class="form-group form-default">
                                                            <label>Email : </label>
                                                                <input type="text" name="input_nama" disabled value="<?=$data['email']?>" class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <label>Nama Lengkap : </label>
                                                                <input type="text" name="input_nama" disabled value="<?=ucwords($data['nama_lengkap'])?>" class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <label>Status Pekerjaan : </label>
                                                                <input type="text" name="input_nama" disabled value="<?=ucwords($data['status_pekerjaan'])?>" class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <a class="example-image-link" href="../assets/images/upload/profil/<?=$data['foto_diri']?>" data-lightbox="example-1"><img src="../assets/images/upload/profil/<?=$data['foto_diri']?>" alt="" style="width:50px;height:50px;"></a>
                                                            </div>

                                                            <div class="form-group form-default">
                                                            <label>Foto KTP : </label><br>
                                                            <a class="example-image-link" href="../assets/images/upload/ktp/<?=$data['foto_ktp']?>" data-lightbox="example-1"><img src="../assets/images/upload/ktp/<?=$data['foto_ktp']?>" alt="" style="width:70px;height:50px;"></a>
                                                            </div>

                                                            <a href="./peserta.php"><button type="submit" name="submit" class="btn btn-primary waves-effect waves-light">Kembali</button></a>
