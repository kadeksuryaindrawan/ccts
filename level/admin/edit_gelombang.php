                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" method="POST" action="./proses/edit_gelombang.proses.php">
                                                        <input type="hidden" name="id_gelombang" value="<?=$id?>">
                                                            <div class="form-group form-default">
                                                                <input type="number" name="input_gelombang" class="form-control" required="" value="<?=$data['nama_gelombang']?>">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Nama Gelombang</label>
                                                            </div>
