                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" method="POST" action="./proses/edit_kategori.proses.php">
                                                        <input type="hidden" name="id_kategori" value="<?=$id?>">
                                                            <div class="form-group form-default">
                                                                <input type="text" name="input_nama_kategori" class="form-control" required="" value="<?=$data['nama_kategori']?>">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Nama Kategori</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <textarea class="form-control" required="" name="input_deskripsi"><?=$data['deskripsi']?></textarea>
                                                                <span class="form-bar"></span>
