                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <!-- Page-body start -->
                                    <div class="page-body">
                                        <a href="./tambah_gelombang.php"><button class="btn btn-primary waves-effect waves-light" style="margin-bottom:15px;">Tambah Gelombang</button></a> 
                                                    ...
                                                    <table class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Aktifkan/Matikan</th>
                                                                <th>Action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                        <?php
                                                            $query = mysqli_query($connection, "SELECT * FROM tb_gelombang WHERE deleted = 0 ORDER BY id_gelombang DESC");
                                                            $nomor = 1;
                                                            while($data = mysqli_fetch_assoc($query)){
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <?php
                                                                            if($data['status_gelombang'] == 'aktif'){
                                                                                ?>
                                                                                    <td class="text-success"><?= ucwords($data['status_gelombang']) ?></td>
                                                                                    <td><a href="./mati_gelombang.php?id=<?php echo $data['id_gelombang'] ?>" onclick = "return confirm('Yakin mematikan gelombang?')"><button class="btn btn-danger waves-effect waves-light" style="margin-bottom:15px;">Matikan Gelombang</button></a> </td>
                                                                                <?php
                                                                            }
                                                                            else{
                                                                                ?>
                                                                                    <td class="text-danger"><?= ucwords($data['status_gelombang']) ?></td>
                                                                                    <td><a href="./aktif_gelombang.php?id=<?php echo $data['id_gelombang'] ?>" onclick = "return confirm('Yakin mengaktifkan gelombang?')"><button class="btn btn-success waves-effect waves-light" style="margin-bottom:15px;">Aktifkan Gelombang</button></a> </td>
                                                                                <?php
                                                                            }
                                                                        ?>
                                                                        <td>
                                                                        <a class="text-primary" href="./edit_gelombang.php?id=<?php echo $data['id_gelombang'] ?>"><button class="btn btn-primary waves-effect waves-light" style="margin-bottom:15px;">Edit</button></a>
                                                                        <a class="text-danger" href="./hapus_gelombang.php?id=<?php echo $data['id_gelombang'] ?>" onclick = "return confirm('Yakin hapus gelombang?')"><button class="btn btn-danger waves-effect waves-light" style="margin-bottom:15px;">Hapus</button></a>
