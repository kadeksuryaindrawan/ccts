                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h5 class="m-b-10">Kategori Bidang</h5>
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <!-- Page-body start -->
                                    <div class="page-body">
                                       <a href="./tambah_kategori.php"><button class="btn btn-primary waves-effect waves-light" style="margin-bottom:15px;">Tambah Kategori</button></a> 
                                                            ...
                                                            while($data = mysqli_fetch_assoc($query)){
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?=substr(strip_tags($data['deskripsi']),0 , 50)?>.....</td>
                                                                        <td>
                                                                        <a class="text-primary" href="./edit_kategori.php?id=<?php echo $data['id_kategori'] ?>"><button class="btn btn-primary waves-effect waves-light" style="margin-bottom:15px;">Edit</button></a>
                                                                        <a class="text-danger" href="./hapus_kategori.php?id=<?php echo $data['id_kategori'] ?>" onclick = "return confirm('Yakin hapus kategori?')"><button class="btn btn-danger waves-effect waves-light" style="margin-bottom:15px;">Hapus</button></a>
