                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <!-- Page-body start -->
                                    <div class="page-body">
                                        <a href="./tambah_materi.php"><button class="btn btn-primary waves-effect waves-light" style="margin-bottom:15px;">Tambah Materi</button></a> 
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                            $query = mysqli_query($connection, "SELECT tb_option.*,tb_soal.*,tb_kategori.* FROM tb_option INNER JOIN tb_soal USING(id_soal) INNER JOIN tb_kategori USING(id_kategori) WHERE tb_soal.deleted = 0 AND tb_option.deleted = 0 AND tb_option.status_option = 1 ORDER BY tb_soal.id_soal DESC");
                                                            $nomor = 1;
                                                            while($data = mysqli_fetch_assoc($query)){
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?=substr(strtolower($data['soal']),0,50)?>....</td>
                                                                        <td><?=strtolower($data['abjad'])?>. <?=substr(strtolower($data['text_abjad']),0,10)?>....</td>
                                                                        <td>
                                                                        <a class="text-primary" href="./edit_materi.php?id=<?php echo $data['id_soal'] ?>"><button class="btn btn-primary waves-effect waves-light" style="margin-bottom:15px;">Edit</button></a>
                                                                        <a class="text-danger" href="./hapus_materi.php?id=<?php echo $data['id_soal'] ?>" onclick = "return confirm('Yakin hapus materi?')"><button class="btn btn-danger waves-effect waves-light" style="margin-bottom:15px;">Hapus</button></a>
