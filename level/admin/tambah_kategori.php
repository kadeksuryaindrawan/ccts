                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" method="POST" action="./proses/tambah_kategori.proses.php">
                                                            <div class="form-group form-default">
                                                                <input type="text" name="input_nama_kategori" class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Nama Kategori</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <textarea class="form-control" required="" name="input_deskripsi"></textarea>
                                                                <span class="form-bar"></span>
