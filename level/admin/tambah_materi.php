                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" method="POST" action="./proses/tambah_materi.proses.php">
                                                            ...
                                                            <div class="form-group form-default">
                                                                <textarea class="form-control" required="" name="input_soal"></textarea>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Masukkan Soal</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="text" name="input_jawaban1" class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Masukkan Jawaban Untuk Abjad A</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="text" name="input_jawaban2" class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Masukkan Jawaban Untuk Abjad B</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="text" name="input_jawaban3" class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Masukkan Jawaban Untuk Abjad C</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <span class="form-bar"></span>
                                                                <label>Pilih Abjad Benar</label>
